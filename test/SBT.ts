...
// 		await expect(
// 			sbt.safeMint(ownerAccount.address, tokenID1)
// 		).to.be.revertedWith("MNT01");
// 	});

// 	it("#3 Should fail minting twice with same tokenID", async function () {
// 		await expect(
// 			sbt.safeMint(otherAccount.address, tokenID0)
// 		).to.be.revertedWith("MNT02");
// 	});
...
// 		await expect(sbt.ownerOf(tokenID0)).to.be.revertedWith(
...
// 		await expect(
// 			sbt.transferFrom(ownerAccount.address, otherAccount.address, tokenID0)
// 		).to.be.reverted;
// 	});
